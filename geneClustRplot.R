...
Gene_Arrow<-function(input,filetype='IMG',close.gene.setback=150,seed.value=1, list.of.colors=NULL){
  ...
  plot(NA, xlim=c(1,max(as.numeric(input$Scaffold.Length..bp.))), ylim=c(-10,200),axes=F, xlab=NA, ylab=NA)
  ...
  segments(c(seq(0,100000,10000)),c(-5),c(seq(0,100000,10000)),c(-3))
